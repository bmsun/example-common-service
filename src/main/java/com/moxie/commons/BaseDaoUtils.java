...
public class BaseDaoUtils {
    ...
    private static String daoContent(String basePackage, String entityName, String table, Map<String, String> nameTypes) {
        ...
        buf.append("import com.moxie.commons.model.Criteria;").append("\n");
        buf.append("import com.moxie.commons.model.JdbcResult;").append("\n");
        buf.append("import com.moxie.commons.model.PageRequest;").append("\n");
